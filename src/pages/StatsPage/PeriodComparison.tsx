...
export const PeriodComparison = () => {
  ...
  return (
    <GlassCard className="p-6">
      ...
      {period === 'custom' && (
        <div className="mb-6 space-y-4 rounded-lg bg-white/50 p-4 backdrop-blur-sm dark:bg-gray-900/50">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-400/20 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
                />
              </div>
              <div>
      ...
      {period === 'custom' && !isCustomValid && (
        <div className="mb-4 rounded-lg bg-orange-50 p-3 text-sm text-orange-700 dark:bg-orange-950/30">
        ...
        <div className="space-y-3">
          {metrics.map((metric) => {
            ...
            return (
              <div
                key={metric}
                className="rounded-lg border border-gray-200/60 bg-white/50 p-4 backdrop-blur-sm dark:border-gray-800/60 dark:bg-gray-900/50"
              >
                {/* Metric Header */}
                ...
                <div className="mt-4 space-y-3">
                  <div>
                    ...
                    <div className="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-gray-200/60 dark:bg-gray-800/60">
                      <div
                        className={clsx(
                  ...
                  <div>
                    ...
                    <div className="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-gray-200/60 dark:bg-gray-800/60">
                      <div
                        className="h-full rounded-full bg-gray-300 transition-all duration-500 dark:bg-gray-700"
