...
import { Bell, ChevronRight, Rss, Timer, Trophy, Users, type LucideIcon } from 'lucide-react';
...
const items: SheetItem[] = [
  ...
  { to: '/feed', labelKey: 'more.feed', icon: Rss, beta: true },
                    ...
                    return (
                      <motion.li key={item.to} variants={itemVariants}>
                        <Link
                          to={item.to}
                          onClick={onClose}
                          className="group flex items-center gap-4 rounded-2xl px-3 py-3 transition-colors hover:bg-gray-50 active:bg-gray-100 dark:hover:bg-gray-800/60 dark:active:bg-gray-800"
                        >
                          <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-strava-orange/10 text-strava-orange">
