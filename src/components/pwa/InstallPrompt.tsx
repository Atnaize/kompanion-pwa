...
export const InstallPrompt = () => {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-50 md:left-auto md:right-4 md:w-96">
      <div className="rounded-2xl bg-white p-4 shadow-2xl dark:bg-gray-900">
            ...
            {isIos ? (
              <>
                ...
                <button
                  ...
                  className="w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 transition-all hover:bg-gray-50 active:scale-95 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-900/50"
                >
                  {t('pwa.install.gotIt')}
                </button>
              </>
              ...
              <>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={handleDismiss}
                    className="rounded-lg border-2 border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 transition-all hover:bg-gray-50 active:scale-95 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-900/50"
                  >
